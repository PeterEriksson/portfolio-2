...
function ReturnToTopBtn(): JSX.Element {
  ...
  return (
    <ScrollLink
      ...
      spy={true}
      offset={-40}
      className={`flex z-50 group cursor-pointer fixed right-4 xs:right-6 bottom-6 items-center justify-center w-12 h-12 border-2 border-gray-700 bg-transparent00 bg-opacity-75 rounded-full transition transform opacity ease-in-out duration-500 ${
